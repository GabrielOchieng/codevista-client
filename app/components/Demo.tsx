      ...
      >
        ...
        >
          ...
          >
            ...
            {"\n"}
            greet(
            <span className="text-(--solar-sky)">&quot;Gabriel&quot;</span>);
          </motion.div>
        </motion.pre>
        ...
        >
          <p className="mb-2 text-(--pure-charcoal)">
            <strong className="text-(--pure-graphite)">CodeVista:</strong> This
            function defines a simple greeting routine.
          </p>
          <p className="text-(--pure-charcoal)">
            It prints{" "}
            <code className="bg-(--solar-ocean) text-(--pure-black) px-1 py-0.5 rounded">
              Hello, Gabriel
            </code>{" "}
